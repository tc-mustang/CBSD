...
#list_genes = "/home/DB/M.esculenta/V6_assembly/Annotation/V6_official/SNPs/all_genes.list" #use this only to test at the notebook
#threshold  = 1  #use this only to test at the notebook
...
os.system("bedtools intersect -a tmp -b /home/DB2/Imputation/IMPUTE2/PROCCESING/IMPUTE2_snps.bed  -wa -wb > %s.intersect" %(list_genes))
